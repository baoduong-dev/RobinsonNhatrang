        ...
        <div className='relative mt-20'>
          <div className='absolute top-20 left-2/4'>
            <div className='relative'>
              <div className='absolute top-0 left-0 w-370px h-420px shadow-2xl origin-bottom -rotate-12 z-10'>
                <img src='/images/service-bg-01.jpg' alt='service-bg-01' className='w-full h-full object-cover object-center' />
              </div>
              <div className='absolute top-20 left-40 w-370px h-420px shadow-2xl origin-bottom rotate-12 z-0'>
                <img src='/images/service-bg-02.jpg' alt='service-bg-01' className='w-full h-full object-cover object-center' />
              </div>
            </div>
          </div>
          <div className='w-350px flex flex-col space-y-4 justify-center items-center'>
          ...
          <div className='relative mb-10 top-10 left-40 w-350px flex flex-col space-y-4 justify-center items-center'>
            <div className='w-90px h-90px rounded-lg bg-robin-100 text-white flex items-center justify-center'>
          ...
          <div className='relative mb-10 -top-10 left-32rem w-350px flex flex-col space-y-4 justify-center items-center'>
            <div className='w-90px h-90px rounded-lg bg-robin-100 text-white flex items-center justify-center'>
          ...
          <div className='relative mb-10 bottom-72 left-3/4 w-350px flex flex-col space-y-4 justify-center items-center'>
            <div className='w-90px h-90px rounded-lg bg-robin-100 text-white flex items-center justify-center'>
